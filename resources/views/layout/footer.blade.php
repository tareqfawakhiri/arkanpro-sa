                        ...
                        <div class="widget footer-widget wow fadeInUp" data-wow-delay=".6s">
                            <div class="gt-widget-about">
                                ...
                                <div class="gt-social style2">
                                    ...
                                    @endif
                                    @if(setting('social-media.twitter_url'))
                                        <a href="{{ setting('social-media.twitter_url') }}" target="_blank"><i
                                                class="fab fa-x"></i></a>
                                    @endif
                                    @if(setting('social-media.instagram_url'))
                                        <a href="{{ setting('social-media.instagram_url') }}" target="_blank"><i
                                                class="fab fa-instagram"></i></a>
                                    @endif
                                    @if(setting('social-media.linkedin_url'))
                                        <a href="{{ setting('social-media.linkedin_url') }}" target="_blank"><i
                                                class="fab fa-linkedin"></i></a>
                                    @endif
                                    @if(setting('social-media.youtube_url'))
                                        <a href="{{ setting('social-media.youtube_url') }}" target="_blank"><i
