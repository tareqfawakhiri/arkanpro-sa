@extends('layout.main')
@section('title', $section->seo_title ? $section->seo_title : trans('general.contact-us'))
                    ...
                    <div class="col-lg-6">
                        <div class="contact-left-items">
                            ...
                            <div class="video-image">
                                <img data-src="{{ asset('assets/img/video.jpg') }}" alt="img">
                                <div class="video-box">
...
{{--                            <p>{{ trans('contact-us.get-ready-desc') }}</p>--}}
    ...
    <div class="map-section">
        <div class="map-items">
            <div class="googpemap">
                <iframe
                    src="{{setting('contact-us.google_map_url')}}"
