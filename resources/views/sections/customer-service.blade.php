        ...
        <div class="container">
            <div class="contact-wrapper">
                <div class="arrow-shape">
                    <img data-src="{{ asset('assets/img/arrow-shape.png') }}" >
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contact-image wow fadeInUp" data-wow-delay=".4s">
                            ...
                            @if(setting('site.customer-service-image'))
                                <img data-src="{{ Voyager::image(setting('site.customer-service-image')) }}" alt="customer-service-img" width="594px">
                            @else
                                <img data-src="{{ asset('assets/img/contact.png') }}" alt="customer-service-img">
                            @endif

                            <div class="cricle-shape">
                                <img data-src="{{ asset('assets/img/circle-shape.png') }}" >
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="contact-content">
                            <div class="section-title mb-40 mxw-650">
                                <div class="subtitle">
                                    <img data-src="{{ asset('assets/img/icon/arrowLeftWhite.svg') }}" alt="icon">
