...
<section class="pricing-section fix section-padding">
        <div class="pricing-wrapper style1">
            <div class="shape1 d-none d-xxl-block"><imgdata-src="{{ asset('assets/img/shape/pricingShape1_1.png') }}" alt="shape"></div>
            <div class="shape2 d-none d-xxl-block"><imgdata-src="{{ asset('assets/img/shape/pricingShape1_2.png') }}" alt="shape"></div>
            <div class="container">
                <div class="section-title title-area  mx-auto mb-25">
                    <div class="subtitle d-flex justify-content-center"><imgdata-src="{{ asset('assets/img/icon/arrowLeft.svg') }}"
                                                                             alt="icon">
                        <span> {{ trans('pricing.our-pricing') }}
                  </span><imgdata-src="{{ asset('assets/img/icon/arrowRight.svg') }}" alt="icon">
                    </div>
                        ...
                        <div class="row gy-5">
                            ...
                            @endif
                                    <div class="pricing-card_header">
                                        ...
                                        <div class="item">
                                            <imgdata-src="{{ asset('assets/img/icon/pricingIcon1_1.svg') }}" alt="icon">
                                        </div>
                                    </div>
                                    <div class="pricing-card_body">
                                        ...
                                        @foreach($plane->pricing_check as $check)
                                            <ul class="checklist style1">
                                                <li><imgdata-src="{{ asset('assets/img/icon/checkmarkIcon.svg') }}" alt="icon">
                                                @if(app()->getLocale() == 'ar')
                                                    {{ $check->title_ar }}
                                                @else
                                                    {{ $check->title }}
                                        ...
                                        @if($uncheck->title)
                                            <ul class="checklist style1">
                                                <li><imgdata-src="{{ asset('assets/img/icon/crossIcon.svg') }}" alt="icon">
                                                @if(app()->getLocale() == 'ar')
                                                    {{ $uncheck->title_ar }}
                                                @else
                                                    {{ $uncheck->title }}
